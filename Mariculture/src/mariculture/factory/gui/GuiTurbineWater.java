...
public class GuiTurbineWater extends GuiContainer {
	...
	public GuiTurbineWater(InventoryPlayer player, TileTurbineWater tile_entity) {
		super(new ContainerTurbineWater(tile_entity, player));
		tile = tile_entity;
	}
