...
public class RenderPressureVessel extends RenderBase {
    ...
    private void renderSide(IBlockAccess world, int x, int y, int z, double yStart, double yEnd) {
        //Set Texture
        setTexture(Core.renderedMachinesMulti, MachineRenderedMultiMeta.PRESSURE_VESSEL);
    ...
    public void renderBlock() {
        ...
        if (isItem()) {
            ...
            if (!(world.getTileEntity(x, y, z - 1) instanceof TilePressureVessel) && !(world.getTileEntity(x + 1, y, z) instanceof TilePressureVessel)) {
                //Side
                setTexture(Core.renderedMachinesMulti, MachineRenderedMultiMeta.PRESSURE_VESSEL);
            ...
            //Top hand side
            if (!(world.getTileEntity(x - 1, y, z) instanceof TilePressureVessel) && !(world.getTileEntity(x, y, z - 1) instanceof TilePressureVessel)) {
                //Side
                setTexture(Core.renderedMachinesMulti, MachineRenderedMultiMeta.PRESSURE_VESSEL);
