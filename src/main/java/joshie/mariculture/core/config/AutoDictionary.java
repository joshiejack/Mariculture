...
import static joshie.mariculture.core.helpers.ConfigHelper.getStringList;
...
public class AutoDictionary {
    //Defaults
    public static final String[] WHITELIST_DEFAULT = new String[] { "ore", "ingot", "block", "nugget", "dust", "gem", "dyeRed", "dyePurple", "dyeCyan", "dyeLightGray", "dyeGray", "dyePink", "dyeLime", "dyeYellow", "dyeLightBlue", "dyeMagenta", "dyeOrange" };

    public static final String[] BLACKLIST_PREFIX_DEFAULT = new String[] { "listAll", "crop", "fish" };
    public static final String[] BLACKLIST_ITEMS_DEFAULT = new String[] { "TConstruct:materials 36", "dye 4", "dye 2", "dye 3", "dye 15", "dye 0" };
    public static final String[] BLACKLIST_DEFAULT = new String[] { "dye", "stickWood", "plankWood", "logWood", "stairWood", "treeLeaves", "treeSapling", "slabWood", "blockGlass", "paneGlass", "stone", "cobblestone", "sandstone", "record" };
