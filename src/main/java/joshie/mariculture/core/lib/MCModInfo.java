...
public class MCModInfo {
    ...
    public static final String AFTER = "required-after:Forge@[" + forge + ",);required-after:Enchiridion@[" + enchiridion + ",);" + "before:Mariculture|API;" + "after:AWWayofTime@[" + blood_magic + ",);after:BiomesOPlenty@[" + bop + ",);" + liquids;
}
