...
public class Enchiridion2Manager {
	private static final String LATEST_VERSION = "2.0"; //The latest version of the dependency 
    ...
    public static boolean isPresent(String required) {
        if (!isLoaded()) {
            ...
            if (FMLCommonHandler.instance().getEffectiveSide().isClient()) {
                FMLCommonHandler.instance().bus().register(new Enchiridion2Manager());
            } else {
