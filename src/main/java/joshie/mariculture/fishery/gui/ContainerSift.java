...
import joshie.mariculture.core.gui.ContainerMariculture;
...
public class ContainerSift extends ContainerMariculture {
    ...
    public ItemStack transferStackInSlot(EntityPlayer player, int par2) {
        ...
        if (slot != null && slot.getHasStack()) {
            ...
            if (par2 < 10) {
                if (!mergeItemStack(itemstack1, 10, 46, true)) return null;
            } else if (!mergeItemStack(itemstack1, 0, 10, false)) return null;
