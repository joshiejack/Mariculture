...
import joshie.mariculture.magic.jewelry.ItemBracelet;
import joshie.mariculture.magic.jewelry.ItemJewelry;
import joshie.mariculture.magic.jewelry.ItemJewelry.JewelryType;
import joshie.mariculture.magic.jewelry.ItemNecklace;
import joshie.mariculture.magic.jewelry.ItemRing;
import joshie.mariculture.magic.jewelry.parts.BindingBasic;
import joshie.mariculture.magic.jewelry.parts.BindingDummy;
import joshie.mariculture.magic.jewelry.parts.BindingGold;
...
import joshie.mariculture.magic.jewelry.parts.MaterialDummy;
import joshie.mariculture.magic.jewelry.parts.MaterialPearlBlack;
import joshie.mariculture.magic.jewelry.parts.MaterialPearlBlue;
import joshie.mariculture.magic.jewelry.parts.MaterialPearlBrown;
import joshie.mariculture.magic.jewelry.parts.MaterialPearlGold;
import joshie.mariculture.magic.jewelry.parts.MaterialPearlGreen;
import joshie.mariculture.magic.jewelry.parts.MaterialPearlOrange;
import joshie.mariculture.magic.jewelry.parts.MaterialPearlPink;
import joshie.mariculture.magic.jewelry.parts.MaterialPearlPurple;
import joshie.mariculture.magic.jewelry.parts.MaterialPearlRed;
...
public class Magic extends RegistrationModule {
    ...
    private void addDungeonChestLoot() {
        if (EnchantHelper.exists(oneRing)) {
            ItemStack oneRing = JewelryHandler.createSpecial((ItemJewelry) ring, JewelryType.RING, joshie.lib.util.Text.YELLOW + "One Ring");
            if (oneRing != null) {
