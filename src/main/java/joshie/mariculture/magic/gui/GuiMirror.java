...
public class GuiMirror extends GuiStorage {
    ...
    public String getName() {
        if (mirror != null) return StatCollector.translateToLocal(((ItemMirror) mirror.getItem()).getUnlocalizedName(mirror) + ".name");
