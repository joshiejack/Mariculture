...
public abstract class ItemJewelry extends ItemMCDamageable {
    ...
    public String getItemStackDisplayName(ItemStack stack) {
        ...
        return joshie.lib.util.Text.localize(getUnlocalizedName(stack));
    }
    ...
    public void registerIcons(IIconRegister iconRegister) {
        ...
        specials.put(joshie.lib.util.Text.YELLOW + "One Ring", iconRegister.registerIcon(Mariculture.modid + ":jewelry/ring/oneRing"));
    }
    ...
    public void getSubItems(Item item, CreativeTabs tab, List list) {
        ...
        ItemStack stack = JewelryHandler.createSpecial((ItemJewelry) item, JewelryType.RING, joshie.lib.util.Text.YELLOW + "One Ring");
        if (stack != null) {
