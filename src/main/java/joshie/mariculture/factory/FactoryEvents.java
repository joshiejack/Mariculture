...
public class FactoryEvents {
    ...
    public void HarvestSpeed(BreakSpeed event) {
        if (event.entity instanceof EntityPlayer) {
            ...
            if (Item.getItemFromBlock(event.block) == Item.getItemFromBlock(Factory.customBlock)) if (player.getCurrentEquippedItem() != null) {
    ...
    public void LivingUpdateEvent(LivingUpdateEvent event) {
        ...
        if (world.isRemote) if (event.entity instanceof EntityPlayer) {
            EntityPlayer player = (EntityPlayer) event.entity;
