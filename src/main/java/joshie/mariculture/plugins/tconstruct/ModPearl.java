...
public class ModPearl extends ItemModifier {
    ...
    public ModPearl(ItemStack[] items, int effect, int inc) {
        ...
        tooltipName = joshie.lib.util.Text.AQUA + "Aquatic";
        increase = inc;
        max = 50;
    }
    ...
    public void modify(ItemStack[] input, ItemStack tool) {
        ...
        if (tags.hasKey(key)) {
            ...
            modifiers -= 1;
            tags.setInteger("Modifiers", modifiers);
            String modName = joshie.lib.util.Text.AQUA + "Pearls (" + increase + "/" + max + ")";
    ...
    void updateModTag(ItemStack tool, int[] keys) {
        ...
        String modName = joshie.lib.util.Text.AQUA + "Pearls (" + keys[0] + "/" + keys[1] + ")";
