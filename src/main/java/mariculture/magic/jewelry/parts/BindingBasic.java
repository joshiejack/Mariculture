...
public class BindingBasic extends JewelryBinding {
	...
	public int getDurabilityBase(JewelryType type) {
		switch (type) {
			case RING:		return 50;
			case BRACELET: 	return 150;
			case NECKLACE: 	return 300;
			default:		return 100;
		}
	}
	...
	public ItemStack getCraftingItem(JewelryType type) {
		switch (type) {
			case RING:		return new ItemStack(Items.iron_ingot);
			case BRACELET: 	return new ItemStack(Items.string);
			case NECKLACE: 	return new ItemStack(Blocks.wool);
			default:		return null;
		}
	}
