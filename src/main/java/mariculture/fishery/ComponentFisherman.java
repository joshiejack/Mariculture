...
public class ComponentFisherman extends ComponentVillage
{
    ...
    public boolean addComponentParts (World world, Random random, StructureBoundingBox sbb)
    {
        ...
        this.placeBlockAtCurrentPosition(world, Block.stairsCobblestone.blockID, this.getMetadataWithOffset(Block.stairsCobblestone.blockID, 0), 2, 1, 0, sbb);
        this.fillWithBlocks(world, sbb, 1, 1, 1, 4, 1, 1, Block.cobblestone.blockID, Block.cobblestone.blockID, false);
        this.fillWithBlocks(world, sbb, 1, 2, 1, 1, 4, 1, Block.cobblestone.blockID, Block.cobblestone.blockID, false);
        this.placeDoorAtCurrentPosition(world, sbb, random, 2, 2, 1, this.getMetadataWithOffset(Block.doorWood.blockID, 1));
        this.placeBlockAtCurrentPosition(world, Block.wood.blockID, 0, 2, 4, 1, sbb);
        this.fillWithBlocks(world, sbb, 3, 2, 1, 3, 4, 1, Block.wood.blockID, Block.wood.blockID, false);
        this.fillWithBlocks(world, sbb, 4, 2, 1, 4, 4, 1, Block.cobblestone.blockID, Block.cobblestone.blockID, false);
