...
public class EntityHook extends EntityFishHook implements IEntityAdditionalSpawnData {
					...
					if (this.field_146045_ax > 0) {
						...
						if (this.field_146038_az > 0) {
							...
							if (this.field_146038_az <= 0) {
								...
								this.field_146045_ax = MathHelper.getRandomIntegerInRange(this.rand, 20, 50);
							} else {
	...
	public void writeEntityToNBT(NBTTagCompound nbt) {
		...
		nbt.setByte("Quality", (byte)this.baitQuality);
    }
	...
	public void readSpawnData(ByteBuf buffer) {
		this.field_146042_b = (EntityPlayer) this.worldObj.getEntityByID(buffer.readInt());
	}
}