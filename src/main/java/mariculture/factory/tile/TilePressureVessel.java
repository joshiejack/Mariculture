...
public class TilePressureVessel extends TileMultiMachineTank {
    ...
    private void fillFLUDD() {
        if (inventory[fludd] != null && inventory[fludd].getItem() instanceof ItemArmorFLUDD) if (tank.getFluidID() == FluidRegistry.getFluidID(Fluids.hp_water) && tank.getFluidAmount() > 0) {
