		...
		if (tile != null) {
			if (axis == ForgeDirection.EAST || axis == ForgeDirection.WEST || axis == ForgeDirection.NORTH || axis == ForgeDirection.SOUTH) {
				Block[] blocks = new Block[] { 
						tile.theBlocks(0), tile.theBlocks(1), tile.theBlocks(4),
						tile.theBlocks(5), tile.theBlocks(3), tile.theBlocks(2) };
				int[] metas = new int[] { 
				...
				Block[] blocks = new Block[] { 
						tile.theBlocks(1), tile.theBlocks(0), tile.theBlocks(2),
						tile.theBlocks(3), tile.theBlocks(4), tile.theBlocks(5) };
				int[] metas = new int[] { 
