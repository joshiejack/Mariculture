...
public class Aesthetics extends RegistrationModule {
    ...
    public void registerRecipes() {
        ...
        addShaped(new ItemStack(Core.limestone, 4, LimestoneMeta.THIN_BRICK), new Object[] { "XY", "YX", 'X', new ItemStack(Core.limestone, 1, LimestoneMeta.BRICK), 'Y', new ItemStack(Core.limestone, 1, LimestoneMeta.SMALL_BRICK) });

        addShaped(new ItemStack(Core.limestone, 2, LimestoneMeta.PILLAR_1), new Object[] { "X", "X", 'X', new ItemStack(Core.limestone, 1, LimestoneMeta.SMOOTH) });

        addShaped(new ItemStack(Core.limestone, 2, LimestoneMeta.PEDESTAL_1), new Object[] { "X", "Y", 'X', new ItemStack(Core.limestone, 1, LimestoneMeta.PILLAR_1), 'Y', new ItemStack(Core.limestone, 1, LimestoneMeta.BORDERED) });
    }
}
