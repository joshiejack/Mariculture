...
public class PluginTConstruct extends Plugin {
	...
	private static void addModifiers() {
		...
		tb.registerToolMod(new ModPearl(new ItemStack[] { pearl }, 20, 1));
		tb.registerToolMod(new ModPearl(new ItemStack[] { pearl, pearl }, 20, 2));
		tb.registerToolMod(new ModPearl(new ItemStack[] { pearlBlock }, 20, 4));
		tb.registerToolMod(new ModPearl(new ItemStack[] { pearl, pearlBlock }, 20, 5));
		tb.registerToolMod(new ModPearl(new ItemStack[] { pearlBlock, pearlBlock }, 20, 8));
