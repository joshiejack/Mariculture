...
public class PluginRailcraft extends Plugin {
	...
	private void addSteelMelting() {
		try {
			...
			RecipesSmelting.addRecipe(Fluids.steel, new Object[] {steelPick, steelShovel, steelAxe, steelSword, steelHoe}, MetalRates.TOOLS, RecipesSmelting.steel, new ItemStack(stick), 1);
			RecipesSmelting.addRecipe(Fluids.steel, new Object[] {steelHelm, steelChest, steelPants, steelBoots}, MetalRates.ARMOR, RecipesSmelting.steel, null, 0);
		} catch (Exception e) {
