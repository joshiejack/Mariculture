...
public class EntityOldSpeedBoat extends Entity {
	...
	public EntityOldSpeedBoat(World par1World) {
		super(par1World);
	...
	public EntityOldSpeedBoat(World world, double x, double y, double z) {
		this(world);
