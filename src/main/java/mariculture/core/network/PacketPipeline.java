...
public class PacketPipeline extends MessageToMessageCodec<FMLProxyPacket, AbstractPacket> {
    ...
    public void initialise() {
        ...
        registerPacket(PacketInventorySync.class);
        registerPacket(PacketDamageJewelry.class);
        registerPacket(PacketJewelrySwap.class);
        registerPacket(PacketSyncMirror.class);
        registerPacket(PacketFluidSync.class);
        registerPacket(PacketRenderRefresh.class);
        registerPacket(PacketEnchant.class);
        registerPacket(PacketTeleport.class);
        registerPacket(PacketAirPump.class);
        registerPacket(PacketOrientationSync.class);
        registerPacket(PacketFLUDD.class);
        registerPacket(PacketTurbine.class);
    }
