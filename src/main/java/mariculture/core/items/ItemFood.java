...
public class ItemFood extends ItemMariculture {
	...
	private ItemStack getLeftovers(int meta) {
		switch(meta) {
			...
			case FoodMeta.CALAMARI_HALF:	return new ItemStack(Item.bowlEmpty);
			case FoodMeta.CUSTARD:			return new ItemStack(Item.bowlEmpty);
			case FoodMeta.FISH_N_CUSTARD:	return new ItemStack(Item.bowlEmpty);
			case FoodMeta.MISO_SOUP_1:		return new ItemStack(Item.bowlEmpty);
