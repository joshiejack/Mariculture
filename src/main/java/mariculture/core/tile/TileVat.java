...
public class TileVat extends TileMultiStorage implements ISidedInventory, IFluidHandler, ITank {
    ...
    private boolean hasRoom(ItemStack stack, FluidStack newFluid) {
        ...
        return stack == null || inventory[1] == null || ItemHelper.areItemStackEqualNoNull(stack, inventory[1]) && inventory[1].stackSize + stack.stackSize <= inventory[1].getMaxStackSize();
    }
