...
public class RenderVoidBottle extends RenderBase {
    ...
    public void renderBlock() {
        ...
        if (!old) {
            ...
            renderAngledBlock(0D, -0.065D, 0D, 0D, -0.065D, 0D, 0D, 0.2D, 1D, 0D, 0.2D, 1D);

            renderAngledBlock(0D, 0.2D, 0D, 0D, 0.2D, 0D, -0.3D, 0.85D, 0.7D, 0.3D, 0.85D, 0.7D);

            renderAngledBlock(-0.3D, 0.85D, -0.3D, 0.3D, 0.85D, -0.3D, -0.3D, 1D, 0.7D, 0.3D, 1D, 0.7D);

            renderAngledBlock(0D, -0.065D, -1D, 0D, -0.065D, -1D, 0D, 0.2D, 0D, 0D, 0.2D, 0D);

            renderAngledBlock(0D, 0.2D, -1D, 0D, 0.2D, -1D, -0.3D, 0.85D, 0.3D, 0.3D, 0.85D, 0.3D);

            renderAngledBlock(-0.3D, 0.85D, -0.7D, 0.3D, 0.85D, -0.7D, -0.3D, 1D, 0.3D, 0.3D, 1D, 0.3D);

            //dun dun
            renderAngledBlock(-1D, 0.2D, 0D, 0D, -0.065D, 0D, -1D, 0.2D, 0D, 0D, -0.065D, 0D);

            renderAngledBlock(-0.7D, 0.85D, -0.3D, 0D, 0.2D, 0D, -0.7D, 0.85D, 0.3D, 0D, 0.2D, 0D);

            renderAngledBlock(-0.7D, 1D, -0.3D, 0.3D, 0.85D, -0.3D, -0.7D, 1D, 0.3D, 0.3D, 0.85D, 0.3D);

            renderAngledBlock(0D, 0.2D, 0D, 1D, -0.065D, 0D, 0D, 0.2D, 0D, 1D, -0.065D, 0D);

            renderAngledBlock(-0.3D, 0.85D, -0.3D, 1D, 0.2D, 0D, -0.3D, 0.85D, 0.3D, 1D, 0.2D, 0D);

            renderAngledBlock(-0.3D, 1D, -0.3D, 0.7D, 0.85D, -0.3D, -0.3D, 1D, 0.3D, 0.7D, 0.85D, 0.3D);

            renderAngledBlock(0D, -0.061D, 0D, 0D, -0.061D, 0D, 0D, -0.061D, 0D, 0D, -0.061D, 0D);
        } else {
