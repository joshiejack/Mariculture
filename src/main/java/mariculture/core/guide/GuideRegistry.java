...
public class GuideRegistry {
	...
	public static void registerIcons() {
		...
		guide.registerIcon("transparentPlastic", new ItemStack(Core.transparent, 1, TransparentMeta.PLASTIC));
		...
		guide.registerIcon("vat", new ItemStack(Core.renderedMultiMachines, 1, DoubleMeta.VAT));
		guide.registerIcon("storage", new ItemStack(Core.machines, 1, MachineMeta.BOOKSHELF));
		...
		guide.registerIcon("baseWood", new ItemStack(Core.woods, 1, WoodMeta.BASE_WOOD));
		...
		guide.registerIcon("copperTank", new ItemStack(Core.tanks, 1, TankMeta.TANK));
		guide.registerIcon("ironBars", new ItemStack(Blocks.iron_bars));
		guide.registerIcon("crucibleFurnace", new ItemStack(Core.multiMachines, 1, MachineMultiMeta.CRUCIBLE));
		guide.registerIcon("baseBrick", new ItemStack(Core.rocks, 1, RockMeta.BASE_BRICK));
		guide.registerIcon("bucketLava", new ItemStack(Items.lava_bucket));
		guide.registerIcon("ladle", new ItemStack(Core.ladle));
		guide.registerIcon("caster", new ItemStack(Core.renderedMachines, 1, SingleMeta.INGOT_CASTER));
		guide.registerIcon("heatglass", new ItemStack(Core.glass, 1, GlassMeta.HEAT));
		...
		guide.registerIcon("blacksmithAnvil", new ItemStack(Core.renderedMachines, 1, SingleMeta.ANVIL_1));
		guide.registerIcon("airPump", new ItemStack(Core.renderedMachines, 1, SingleMeta.AIR_PUMP));
		...
		guide.registerIcon("aluminumBlock", new ItemStack(Core.metals, 1, MetalMeta.ALUMINUM_BLOCK));
		...
		guide.registerIcon("baseIron", new ItemStack(Core.metals, 1, MetalMeta.BASE_IRON));
		...
		if(Modules.diving.isActive()) {
			...
			guide.registerIcon("compressorTop", new ItemStack(Core.renderedMultiMachines, 1, DoubleMeta.COMPRESSOR_TOP));
			guide.registerIcon("compressorBase", new ItemStack(Core.renderedMultiMachines, 1, DoubleMeta.COMPRESSOR_BASE));
		}
		
		if(Modules.factory.isActive()) {
			guide.registerIcon("autodictionary", new ItemStack(Core.machines, 1, MachineMeta.DICTIONARY_ITEM));
			...
			guide.registerIcon("sawmill", new ItemStack(Core.machines, 1, MachineMeta.SAWMILL));
			guide.registerIcon("paintbrush", new ItemStack(Factory.paintbrush));
			guide.registerIcon("turbineManual", new ItemStack(Core.renderedMachines, 1, SingleMeta.TURBINE_HAND));
			guide.registerIcon("turbineWater", new ItemStack(Core.renderedMachines, 1, SingleMeta.TURBINE_WATER));
			guide.registerIcon("turbineGas", new ItemStack(Core.renderedMachines, 1, SingleMeta.TURBINE_GAS));
			guide.registerIcon("sluice", new ItemStack(Core.machines, 1, MachineMeta.SLUICE));
			...
			guide.registerIcon("geyser", new ItemStack(Core.renderedMachines, 1, SingleMeta.GEYSER));
			guide.registerIcon("fishSorter", new ItemStack(Core.machines, 1, MachineMeta.FISH_SORTER));
			guide.registerIcon("mechanizedSponge", new ItemStack(Core.machines, 1, MachineMeta.SPONGE));
			guide.registerIcon("fludd", new ItemStack(Factory.fludd));
			guide.registerIcon("pressureVessel", new ItemStack(Core.renderedMultiMachines, 1, DoubleMeta.PRESSURE_VESSEL));
		}
		
		if(Modules.fishery.isActive()) {
			guide.registerIcon("polishedLog", new ItemStack(Core.woods, 1, WoodMeta.POLISHED_LOG));
			guide.registerIcon("polishedPlank", new ItemStack(Core.woods, 1, WoodMeta.POLISHED_PLANK));
			...
			guide.registerIcon("autofisher", new ItemStack(Core.machines, 1, MachineMeta.AUTOFISHER));
			guide.registerIcon("feeder", new ItemStack(Core.renderedMachines, 1, SingleMeta.FISH_FEEDER));
			guide.registerIcon("incubatorBase", new ItemStack(Core.multiMachines, 1, MachineMultiMeta.INCUBATOR_BASE));
			guide.registerIcon("incubatorTop", new ItemStack(Core.multiMachines, 1, MachineMultiMeta.INCUBATOR_TOP));
