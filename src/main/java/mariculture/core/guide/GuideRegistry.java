...
public class GuideRegistry {
	...
	public static void registerIcons() {
		/** Rotatables **/
		guide.registerCyclingMetaIcon("wool", new ItemStack(Blocks.cloth), 16);
		...
		guide.registerOreDicIcon("ingotGold", new ItemStack(Items.ingotGold));
		guide.registerOreDicIcon("ingotIron", new ItemStack(Items.ingotIron));
		...
		guide.registerOreDicIcon("logWood", new ItemStack(Blocks.wood));
		guide.registerOreDicIcon("dyeLightBlue", new ItemStack(Items.dyePowder, 1, Dye.LIGHT_BLUE));
		guide.registerOreDicIcon("dyeBrown", new ItemStack(Items.dyePowder, 1, Dye.BROWN));
		guide.registerOreDicIcon("glass", new ItemStack(Blocks.glass));
		guide.registerOreDicIcon("dyeBlack", new ItemStack(Items.dyePowder, 1, Dye.INK));
		guide.registerOreDicIcon("dyeYellow", new ItemStack(Items.dyePowder, 1, Dye.YELLOW));
		guide.registerOreDicIcon("dyeBlue", new ItemStack(Items.dyePowder, 1, Dye.LAPIS));
		guide.registerOreDicIcon("dyeWhite", new ItemStack(Items.dyePowder, 1, Dye.BONE));
		guide.registerOreDicIcon("dyeGreen", new ItemStack(Items.dyePowder, 1, Dye.GREEN));
		guide.registerOreDicIcon("dyeRed", new ItemStack(Items.dyePowder, 1, Dye.RED));
		guide.registerOreDicIcon("dyeCyan", new ItemStack(Items.dyePowder, 1, Dye.CYAN));
		guide.registerOreDicIcon("slabWood", new ItemStack(Blocks.woodSingleSlab));
		...
		guide.registerIcon("reed", new ItemStack(Items.reed));
		guide.registerIcon("blank", new ItemStack(Core.airBlocks, 1, AirMeta.FAKE_AIR));
		guide.registerIcon("glassPane", new ItemStack(Blocks.thinGlass));
		...
		guide.registerIcon("enchant", new ItemStack(Blocks.enchantmentTable));
		guide.registerIcon("netherStar", new ItemStack(Items.netherStar));
		...
		guide.registerIcon("string", new ItemStack(Items.silk));
		...
		guide.registerIcon("rawFish", new ItemStack(Items.fishRaw));
		...
		guide.registerIcon("stainedClayWhite", new ItemStack(Blocks.stainedClay, 1, 0));
		guide.registerIcon("stainedClayLightBlue", new ItemStack(Blocks.stainedClay, 1, 3));
		...
		guide.registerIcon("netherBrick", new ItemStack(Items.netherrackBrick));
		guide.registerIcon("copperTank", new ItemStack(Core.tankBlocks, 1, TankMeta.TANK));
		guide.registerIcon("ironBars", new ItemStack(Blocks.fenceIron));
		...
		guide.registerIcon("bucketLava", new ItemStack(Items.bucketLava));
		...
		guide.registerIcon("netherBrickBlock", new ItemStack(Blocks.netherBrick));
		...
		guide.registerIcon("piston", new ItemStack(Blocks.pistonBase));
		guide.registerIcon("ironWheel", new ItemStack(Core.craftingItem, 1, CraftingMeta.WHEEL));
		guide.registerIcon("nightVisionPotion", new ItemStack(Items.potion, 1, 8198));
		...
		guide.registerIcon("bookNQuill", new ItemStack(Items.writableBook));
		guide.registerIcon("feather", new ItemStack(Items.feather));
		guide.registerIcon("hopper", new ItemStack(Blocks.hopperBlock));
		guide.registerIcon("limestone", new ItemStack(Core.oreBlocks, 1, OresMeta.LIMESTONE));
		guide.registerIcon("ironAxe", new ItemStack(Items.axeIron));
		guide.registerIcon("baseIron", new ItemStack(Core.oreBlocks, 1, OresMeta.BASE_IRON));
		guide.registerIcon("slabQuartz", new ItemStack(Blocks.stoneSingleSlab, 1, 7));
		guide.registerIcon("slabStone", new ItemStack(Blocks.stoneSingleSlab, 1, 0));
		guide.registerIcon("bucketWater", new ItemStack(Items.bucketWater));
		guide.registerIcon("blockLapis", new ItemStack(Blocks.blockLapis));
		...
		guide.registerIcon("magicDroplet", new ItemStack(Items.ghastTear));
		guide.registerIcon("sponge", new ItemStack(Items.bucketWater));
		guide.registerIcon("fishingNet", new ItemStack(Blocks.chest));
		guide.registerIcon("waterDroplet", new ItemStack(Items.potion, 1, 0));
		guide.registerIcon("fish", new ItemStack(Items.fishRaw));
