...
public class MCModInfo {
    ...
    public static final String AFTER = "required-after:Forge@[" + forge + ",);" + ";after:Enchiridion2;after:modtweaker2;after:Forestry;after:AWWayofTime@[" + blood_magic + ",);after:BiomesOPlenty@[" + bop + ",);" + liquids;
}
