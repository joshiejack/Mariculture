...
public class MachineRenderedMeta {
    ...
    public static final int FLUDD_STAND = 4;    /** MT **/
    public static final int ROTOR_COPPER = 5;   /** MT **/
    public static final int ROTOR_ALUMINUM = 6; /** MT **/
    public static final int ROTOR_TITANIUM = 7; /** MT **/
