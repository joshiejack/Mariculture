...
public class Compatibility {
	...
	//TODO: Update this with the stupid new ore dictionary names
	public static final String[] BLACKLIST_DEFAULT = new String[] { "dye", "dyeBlue", "dyeBlack", "dyeWhite", "dyeGreen", "dyeBrown", "stickWood", "plankWood",
		"logWood", "stairWood", "treeLeaves", "treeSapling", "glass", "sandstone", "slabWood"};
