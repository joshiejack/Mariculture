...
public class BlockRenderedMachineItem extends ItemBlockMariculture {
	...
	public String getName(ItemStack stack) {
		switch (stack.getItemDamage()) {
			case MachineRenderedMeta.AIR_PUMP: 		return "airpump";
			case MachineRenderedMeta.FISH_FEEDER: 	return "feeder";
			case MachineRenderedMeta.TURBINE_WATER: return "turbine";
			case MachineRenderedMeta.FLUDD_STAND:   return "fludd";
			case MachineRenderedMeta.TURBINE_GAS: 	return "turbineGas";
			case MachineRenderedMeta.GEYSER: 		return "geyser";
