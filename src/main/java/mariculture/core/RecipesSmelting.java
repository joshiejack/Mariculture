...
public class RecipesSmelting {
    ...
    public static void postAdd() {
        ...
        //Copperous Dust
        LinkedMetal[] coppers = new LinkedMetal[] { new LinkedMetal("ingotIron", Fluids.iron, 4), new LinkedMetal("ingotSilver", Fluids.silver, 7), new LinkedMetal("ingotGold", Fluids.gold, 10), new LinkedMetal("ingotCobalt", Fluids.cobalt, 15), new LinkedMetal("ingotNickel", Fluids.nickel, 8), new LinkedMetal("ingotLead", Fluids.lead, 7), new LinkedMetal("ingotTin", Fluids.tin, 6) };
        ...
        //Ironic Dust
        LinkedMetal[] irons = new LinkedMetal[] { new LinkedMetal("ingotAluminum", Fluids.aluminum, 3), new LinkedMetal("ingotTin", Fluids.iron, 8), new LinkedMetal("ingotCopper", Fluids.copper, 6) };
        addDust(MaterialsMeta.DUST_IRONIC, iron, silicon, 6, irons);

        //Leader Dust
        LinkedMetal[] leads = new LinkedMetal[] { new LinkedMetal("ingotSilver", Fluids.silver, 3), new LinkedMetal("ingotIron", Fluids.iron, 6), new LinkedMetal("ingotCopper", Fluids.copper, 8), new LinkedMetal("ingotTin", Fluids.tin, 10) };
        addDust(MaterialsMeta.DUST_LEADER, lead, null, 0, leads);

        //Silvery Dust
        LinkedMetal[] silvers = new LinkedMetal[] { new LinkedMetal("ingotLead", Fluids.lead, 2), new LinkedMetal("ingotElectrum", Fluids.electrum, 4) };
        addDust(MaterialsMeta.DUST_SILVERY, silver, sulfur, 5, silvers);

        //Tinnic Dust
        LinkedMetal[] tins = new LinkedMetal[] { new LinkedMetal("ingotCopper", Fluids.copper, 3), new LinkedMetal("ingotIron", Fluids.iron, 6), new LinkedMetal("ingotLead", Fluids.lead, 8) };
    ...
    public static void addMetalRecipes() {
        ...
        RecipeHelper.addVatItemRecipe(new ItemStack(glass, 32), Fluids.natural_gas, 25000, new ItemStack(Core.transparent, 32, TransparentMeta.PLASTIC), 60);
        ...
        if (FluidRegistry.getFluid("bioethanol") != null) {
            RecipeHelper.addVatItemRecipe(new ItemStack(glass, 32), "bioethanol", 30000, new ItemStack(Core.transparent, 32, TransparentMeta.PLASTIC), 100);
            RecipeHelper.addVatItemRecipe(new ItemStack(glass), "bioethanol", 1500, new ItemStack(Core.transparent, 1, TransparentMeta.PLASTIC), 10);
        }
        ...
        for (ItemStack stack : OreDictionary.getOres("blockLimestone")) {
            ...
            RecipeHelper.addMelting(stack, 825, get(Fluids.quicklime, 900));
            added.add(stack);
        }
        ...
        RecipeHelper.addFluidAlloyNItemResultItem(get(Fluids.aluminum, MetalRates.NUGGET * 64), get(Fluids.quicklime, 20000), new ItemStack(glass, 64), new ItemStack(Core.glass, 64, GlassMeta.HEAT), 90);
        RecipeHelper.addFluidAlloyNItemResultItem(get(Fluids.aluminum, MetalRates.NUGGET), get(Fluids.quicklime, 450), new ItemStack(glass), new ItemStack(Core.glass, 1, GlassMeta.HEAT), 5);
    }
