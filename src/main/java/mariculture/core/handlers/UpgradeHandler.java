...
public class UpgradeHandler implements IUpgradeHandler {
	...
	public int getData(String type, IUpgradable tile) {
		...
		return type.equalsIgnoreCase("salinity")? salinity: type.equalsIgnoreCase("storage")? storage : type.equalsIgnoreCase("temp")? temp : 
			   type.equalsIgnoreCase("purity")? purity : type.equalsIgnoreCase("speed")? speed: type.equalsIgnoreCase("rf")? rf: 0;
	}
