...
public class GuiTurbineGas extends GuiContainer {
	...
	private final TileTurbineGas tile;

	public GuiTurbineGas(InventoryPlayer player, TileTurbineGas tile_entity) {
		super(new ContainerTurbineGas(tile_entity, player));
		tile = tile_entity;
	}
