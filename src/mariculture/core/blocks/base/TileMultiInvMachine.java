...
public abstract class TileMultiInvMachine extends TileMultiInv implements IUpgradable, IMachine, ISidedInventory, IRedstoneControlled, IEjectable, IProgressable {
	...
	public RedstoneMode getRSMode() {
		if(mstr == null)
			return RedstoneMode.DISABLED;
		else
			return mode != null ? ((TileMultiInvMachine)worldObj.getBlockTileEntity(mstr.x, mstr.y, mstr.z)).mode : RedstoneMode.DISABLED;
	}
	...
	public EjectSetting getEjectSetting() {
		if(mstr == null)
			...
			return setting != null ? ((TileMultiInvMachine)worldObj.getBlockTileEntity(mstr.x, mstr.y, mstr.z)).setting : EjectSetting.NONE;
	}
