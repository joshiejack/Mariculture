...
public class RenderFakeItem extends RenderItem
{
     ...
     * Renders the item
     */
    public void doRenderItem(EntityFakeItem entity, double par2, double par4, double par6, float par8, float par9) {
    ...
    protected ResourceLocation func_110796_a(EntityFakeItem par1EntityItem)
    {
     ...
     */
    private void renderDroppedItem(EntityFakeItem par1EntityItem, Icon par2Icon, int par3, float par4, float par5, float par6, float par7)
    {
        renderDroppedItem(par1EntityItem, par2Icon, par3, par4, par5, par6, par7, 0);
    }
    private void renderDroppedItem(EntityFakeItem par1EntityItem, Icon par2Icon, int par3, float par4, float par5, float par6, float par7, int pass)
    {
    ...
    {
        return this.func_110796_a((EntityFakeItem)par1Entity);
    }
